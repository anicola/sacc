...
class Binning(object):
    def __init__ (self, typ, ls, rs, T1, Q1, T2, Q2, window=None, deltaLS=None, sunit=None):
        self.sunit=sunit ## angular separation unit
        self.dtype=[('type','S1'),('ls','f4'),('rs','f4') ('T1','i4'),('Q1','S1'), ('T2','i4'),('Q2','S1')]
        if typ is not None:
            N=len(typ)
    ...
    def loadFromHDF (Binning,group):
        ...
        return  Binning(d['type'],d['ls'],d['rs'],d['T1'],d['Q1'],d['T2'],d['Q2'],window, deltaLS,sunit)
